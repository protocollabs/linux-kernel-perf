...
extern void audit_log_d_path_exe(struct audit_buffer *ab, struct mm_struct *mm);
...
extern int auditsc_get_stamp(struct audit_context *ctx, struct timespec64 *t,
			     unsigned int *serial);
